...
Ajouts :
Comme mentionné un peu plus haut, nous avons ajouté l'option d'activer ou désactiver le « Player » ainsi que l’option de modifier le nombre d'agents leaders. De plus, le nombre d'agents suivant chaque leader est déterminé de telle sorte que chaque leader aura un nombre identique d'agents les suivant pour ne pas faire de dispute.
De plus, il est possible d'enlever tous les leaders (mettre les NumLeaders et PlayerIsEnabled a 0 et on aura 20 agents avec un comportement de flocking.
